<?php
  ...
  elseif ((isset($_SESSION['logged'])) && ($_SESSION['logged']==true) && (strcmp($_SESSION['user_cargo'],"Administrador") == 0) )
  {
...
<html>
  <head>
    ...
    <link href="css/cliente_main_page.css" rel="stylesheet" />
  </head>
  <body>
    <header>
      <nav>
        <div class="navbar-start-wrap">
          <span style="font-size:30px;cursor:pointer"  onclick="window.location.href ='perfil.php'">&#9776;</span>
      ...
      <form action="catalogo_logado.php" method="post">
        ...
        <div class="inner-form">
          ...
          <div class="input-field third-wrap">
            <button class="btn-search" type="submit" onclick="window.location.href='catalogo_logado.php'">
